...
If you are using Metamask Dapp browser, you can now import the Mnemonic 12 words generated by ganache-cli from Step 5 of [**Test The Smart Contract in DShops subfolder**](#Test-The-Smart-Contract-in-DShops-subfolder). The first account should be the Contract Owner / Admin of DShops.
