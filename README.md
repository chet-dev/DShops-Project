...
Note: You can note down the deployed DShops.sol contract address manually for troubleshooting later, if necessary. This contract address should be the same as the one in **DShops.abi.js** (Refer Step 3 of [Test The Frontend Web App in dshopsvue subfolder](#Test-The-Frontend-Web-App-in-dshopsvue-subfolder))
